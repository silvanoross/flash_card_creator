...
# ─── header ───────────────────────────────────────────────────────────────────
st.markdown('<div class="main-title">🧠 FlashCard Study</div>', unsafe_allow_html=True)


col_m1, col_m2, _ = st.columns([1, 1, 4])
with col_m1:
    st.badge(label="Remember good", icon='🧠', color='green')
with col_m2:
    st.badge(label='Think hard', icon='🧐', color='violet')
...
st.markdown('<div class="section-header">Study Session</div>',
            unsafe_allow_html=True)
